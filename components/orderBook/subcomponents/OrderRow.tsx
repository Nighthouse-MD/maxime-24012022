...
import styles, { greenbackgroundgraph, redbackgroundgraph } from '../OrderBook.module.scss';
...
const OrderRow = ({ price, quantity, cumulativeVolume, volumePercentage, type }: OrderRowProps) => {
    ...
    const dynamicRowStyle = { background: `linear-gradient(to ${gradientDirection}, ${type === OrderType.ask ? redbackgroundgraph : greenbackgroundgraph} ${volumePercentage}%, transparent 0)` };
